...
export default function Contact() {
  return (
    <section
      name="contact"
      className="relative z-10 text-white overflow-hidden py-20 lg:py-[120px]"
    >
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="mb-12 max-w-[500px] lg:mb-0">
              <span className="lg:mx-8 mx-4 text-4xl font-bold text-[#cdccfd]">
                Contact Us
              </span>
              <h2 className="lg:mx-8 mx-4 my-6 text-lg font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                GET IN TOUCH 
              </h2>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className=" text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  <svg width="24" height="26" viewBox="0 0 24 26" fill="#13C296">
                ...
                <div className="w-full">
                  ...
                  <a href="tel:+254 710 363 256" className="text-body-color text-base">
                  +254 710 363 256
                  </a>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className=" text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  <svg width="28" height="19" viewBox="0 0 28 19" fill="#13C296">
                ...
                <div className="w-full">
                  ...
                  <a  href='mailto:carreuky@gmail.com' className="text-body-color text-base">
                  carreuky@gmail.com
                  </a>
                </div>
              </div>
              ...
              <form>
                <div className="mb-6">
                  <input
                    ...
                    className="bg-transparent text-body-color border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="bg-transparent text-body-color border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
                    type="submit"
                    className="bg-transparent border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
